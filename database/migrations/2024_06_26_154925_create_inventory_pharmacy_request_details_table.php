...
return new class extends Migration
{
    ...
    {
        Schema::create('inventory_pharmacy_request_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('store_room_request_id')->references('id')->on('inventory_pharmacy_requests');
        });
    }
    ...
    {
        Schema::dropIfExists('inventory_pharmacy_request_details');
    }
};