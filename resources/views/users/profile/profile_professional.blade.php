                    ...
                    <form action="{{route('profiles.updateProfessional')}}" method="post">
                        ...
                        <x-form.form-group>
                            <div class="col-span-12">
                                ...
                                <x-form.form-input name="matriculation" value="{{ old('matriculation') ?? $db->matriculation }}" placeholder="99.999-2" maxlength="8" minlength="6"  onkeyup="handleMatriculation(event)" required />
