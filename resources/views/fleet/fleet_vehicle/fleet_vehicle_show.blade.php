    ...
    @slot('body')
        ...
        <x-conteiner>
            ...
            <div class="grid grid-cols-5 justify-center items-center gap-3 lg:gap-5 text-xs mt-4 mb-2">
                <a 
                    href="{{route('fleet_vehicles.create_category',['fleet_vehicle'=>$db->id, 'create_category'=>'abastecimento'])}}" 
                ...
                <a 
                    href="{{route('fleet_vehicles.create_category',['fleet_vehicle'=>$db->id, 'create_category'=>'serviços'])}}" 
                ...
                <a 
                    href="{{route('fleet_vehicles.create_category',['fleet_vehicle'=>$db->id, 'create_category'=>'despesas'])}}"  
                ...
                <a 
                    href="{{route('fleet_vehicles.create_category',['fleet_vehicle'=>$db->id, 'create_category'=>'vistoria'])}}" 
                ...
                <div class="h-max-[600px] lg:h-96 overflow-y-scroll">
                    ...
                    <div class="pl-2 flex">
                        ...
                        <div class="px-2 w-full">
                            @foreach ($dbOdometers as $dbOdometer)                                
                                <button class="w-full text-start grid grid-cols-1 text-sm border-b border-zinc-300 py-2 relative">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p><span class="font-semibold">Odomêtro: </span>{{$dbOdometer->odometer}}</p>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="w-8 text-center fas fa-gas-pump text-gray-300 pr-2"></i>
                                        <p><span class="font-semibold">Local: </span>{{$dbOdometer->establishment}}</p>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="w-8 text-center fas fa-burn text-gray-300 pr-2"></i>
                                        <p><span class="font-semibold">Combustivel: </span>{{$dbOdometer->category_description}}</p>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="w-8 text-center fas fa-dollar-sign text-gray-300 pr-2"></i>
                                        <p><span class="font-semibold">Preço /L: </span>R${{$dbOdometer->value_unit}}</p>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="w-8 text-center fas fa-money-bill-alt text-gray-300 pr-2"></i>
                                        <p><span class="font-semibold">Valor: </span>R${{$dbOdometer->value_total}}</p>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="w-8 text-center fas fa-tint text-gray-300 pr-2"></i>
                                        <p><span class="font-semibold">Litros: </span>{{$dbOdometer->value_total / $dbOdometer->value_unit}} L</p>
                                    </div>
                                </button>
                            @endforeach
                        </div>
